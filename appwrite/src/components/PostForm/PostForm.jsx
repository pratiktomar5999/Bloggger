...
const PostForm = ({post}) => {
    ...
    const {register, handleSubmit, watch , setValue, control, getValues} = useForm({defaultValues:{title: post?.title || ''},
    slug: post?.slug || '',
    ...
    <form onSubmit={handleSubmit(submit)} className='flex flex-wrap'>
        <div className="w-2/3 px-2">
            ...
            <div className="w-1/3 px-2">
                <Input label="Feature Image: " type="file" className='mb-4' accept="image/png, image/jpg, image/jpeg image/gif"
                ...
                <Select options={['active','inactive']}
                    label='Status' className='mb-4' {...register("status",{required: true})}></Select>
